...
export default function Competicoes({ onBack, onSelect }) {
  const competicoes = [
    ...
    { id: 'mundial', nome: "FIFA Intercontinental Cup", tipo: "MATA_MATA", pais: "/images/fifa.png", logo: "/images/mundial.png" },
    { id: 'world cup', nome: "FIFA World Cup 2026", tipo: "GRUPOS_MATA", pais:"/images/fifa.png", logo: "/images/fifa2026.webp"},
  ];
    ...
    <main className="flex-grow bg-[#959595] flex flex-col h-full overflow-y-auto font-sans uppercase italic font-bold">
      ...
      <div className="flex items-center justify-between p-2 md:p-4 bg-[#1a2024] border-b border-white/10 shrink-0 shadow-lg">
        ...
        <div className="flex items-center gap-1.5 md:gap-2 px-2 text-center">
          <span className="text-[9px] md:text-xs text-zinc-400 tracking-tighter uppercase">COMPETIÇÕES 2026</span>
        </div>
