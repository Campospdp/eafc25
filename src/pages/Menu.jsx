...
export default function Menu({ onBack, onGoCalendario, onGoEstatisticas, onGoCompeticoes, onGoTransferencias , onGoEscalacao }) {
  // Agora o quarto item deixa de ser vazio e vira TRANSFERÊNCIAS
  const itens = ["CALENDÁRIO", "COMPETIÇÕES", "ESTATÍSTICAS", "TRANSFERÊNCIAS" , "ESCALAÇÃO" ];
        ...
        {itens.map((titulo, index) => (
          <div 
            ...
            onClick={() => {
              ...
              if (titulo === "ESCALAÇÃO") onGoEscalacao();
            }}
          ...
          >
            ...
            <div className="w-12 h-12 flex items-center justify-center text-black opacity-40 group-hover:opacity-100 transition-all duration-300">
              ...
              {titulo === "ESCALAÇÃO" && (
                <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="black" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
                  <path d="M16 2v4"/><path d="M8 2v4"/><rect width="16" height="18" x="4" y="4" rx="2"/><path d="M12 11h.01"/><path d="M12 15h.01"/><path d="M8 11h.01"/><path d="M8 15h.01"/><path d="M16 11h.01"/><path d="M16 15h.01"/>
                </svg>
              )}
            </div>
