    ...
    <main className="flex-grow bg-[#959595] flex flex-col h-full overflow-y-auto font-sans uppercase italic font-bold">
      ...
      <div className="flex-1 flex items-center justify-center p-4 sm:p-8">
        <div className="relative w-full max-w-[550px] aspect-[3/4.5] bg-gradient-to-b from-[#1a1a1a] to-[#0a0a0a] rounded-[3rem] border-[6px] border-[#222] shadow-[0_30px_60px_rgba(0,0,0,0.7)] overflow-hidden flex flex-col justify-between p-6 py-12">
          ...
          <div className="flex justify-center z-10 -my-4">
            <PlayerCard name="Garro" rating="80" img="/players/Garro.png" />
          </div>

          <div className="flex justify-around px-12 z-10">
            <PlayerCard name="Bidon" rating="77" img="/players/Bidon.webp" />
            <PlayerCard name="Hatate" rating="78" img="/players/Hatate.jpg" />
          </div>

          {/* DEFESA */}
          <div className="flex justify-between items-end z-10 px-2">
            <PlayerCard name="M.Bidu" rating="75" img="/players/Bidu.webp" />
            <div className="flex gap-4">
              <PlayerCard name="Koulibaly" rating="80" img="/players/Koulibaly.png" />
              <PlayerCard name="Tchoca" rating="75" img="/players/Tchoca.webp" />
            </div>
            <PlayerCard name="Matheusinho" rating="77" img="/players/Matheuzinho.webp" />
          </div>

          {/* GOLEIRO */}
          <div className="flex justify-center z-10 -mb-4">
            <PlayerCard name="Neuer" rating="82" img="/players/Neuer.webp" />
          </div>
        </div>
      </div>
      ...
      <div className="w-full max-w-2xl mx-auto px-4 pb-20">
        <div className="grid grid-cols-4 gap-y-6 gap-x-2 justify-items-center bg-[#1a1a1a] p-5 rounded-[2rem] shadow-xl border border-white/5">
          <PlayerCard name="Djiku" rating="78" img="/djiku.png" isBench />
          <PlayerCard name="Reguilón" rating="76" img="/reguilon.png" isBench />
          <PlayerCard name="Mathinho" rating="77" img="/math.png" isBench />
          <PlayerCard name="M. Pereira" rating="75" img="/matheus.png" isBench />
          <PlayerCard name="Moscardo" rating="74" img="/moscardo.png" isBench />
          <PlayerCard name="Coronado" rating="74" img="/coronado.png" isBench />
          <PlayerCard name="R. Guedes" rating="80" img="/guedes.png" isBench />
        </div>
      </div>
    </main>
  );
