...
import TabelaCopaDoMundo from './pages/TabelaCopaDoMundo';
      ...
      <main className="flex-grow overflow-hidden flex flex-col">
        ...
        {telaAtiva === 'menu' && (
          <Menu 
            ...
            onGoEscalacao={() => setTelaAtiva('escalacao')}
          />
        )}
        ...
        {telaAtiva === 'selecao' && (
          <Competicoes 
            ...
            onSelect={(comp) => {
              ...
              } else if (comp.id === "world cup") {
                setTelaAtiva('tabela_copadomundo')
              }
            }} 
          />
        )}
        ...
        {telaAtiva === 'tabela_copadomundo' && (
        <TabelaCopaDoMundo onBack={() => setTelaAtiva('selecao')} />
        )}
        ...
        {telaAtiva === 'escalacao' && (
          <Escalacao onBack={() => setTelaAtiva('menu')} />
        )}
      </main>
